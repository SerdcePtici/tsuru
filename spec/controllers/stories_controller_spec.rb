...
describe StoriesController do
  ...
  describe 'GET index' do
    ...
    let!(:magic_story) { create :magic_story }

    describe 'simple_stories' do
    ...
    describe 'magic stories' do
      it 'assigns all stories as @stories' do
        get :index, {magic: 'true'}, valid_session
        expect(assigns(:stories)).to eq([magic_story])
      end
    end
  end
  ...
  describe 'POST create' do
    ...
    describe 'with invalid params' do
      it 'assigns a newly created but unsaved story as @story' do
        ...
        post :create, {story: {'author' => 'invalid value'}}, valid_session
        expect(assigns(:story)).to be_a_new(Story)
      end
    end
  end
